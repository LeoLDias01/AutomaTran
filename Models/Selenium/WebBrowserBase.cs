    ...
    public class WebBrowserBase : IDisposable, IWebBrowserBase
    {
        ...
        public bool SetValue(string xPath, string value)
        {
            try
            {
                ...
                return element.CustomSendKeys(OpenQA.Selenium.Keys.Home + value);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool SetValueByName(string Name, string value)
        {
            try
            {
                ...
                element.CustomSendKeys(OpenQA.Selenium.Keys.Home);
                element.CustomSendKeys(OpenQA.Selenium.Keys.Control + "A");
                element.CustomSendKeys(OpenQA.Selenium.Keys.Delete);
        ...
        public bool Submit(string xPath)
        {
            ...
            return result.CustomSendKeys(OpenQA.Selenium.Keys.Enter);
        }
